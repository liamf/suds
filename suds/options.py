...
class Options(Skin):
    ...
    def __init__(self, **kwargs):
        ...
        definitions = [
            ...
            # Zend options, allow us to add Zend debug parameters to the Client options
            Definition('zenddebug', int, 0),
            Definition('zenddebughost', basestring, None),
            Definition('zenddebugport', int, 0), 
